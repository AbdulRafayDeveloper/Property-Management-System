...
const sendEmail = async (info, receiverEmail, body) => {
    ...
    <body>
        <div class="container">
            <div class="header">
                <h2>Hosmuntina Property</h2>
            </div>
            <div class="containerVerify">
                ${body}
            </div>
            <div class="footer">
                &copy; 2023 All rights reserved | Hosmuntina Property<br>
            </div>
        </div>
    </body>
    </html>`;
    ...
    switch (info) {
        case 'Verify':
            ...
            break;
        default:
            subject = 'Hosmuntina Property'
            break;
    }


    const mailOptions = {
        from: '"Hosmuntina Property" <' + process.env.EMAIL_USER + '>',
        to: recipients,
        subject,
        html: emailTemplate
    };
