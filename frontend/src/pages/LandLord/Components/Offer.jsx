...
import ic5 from "../../../assets/images/lc5.jpg";
  ...
  return (
    <section style={{ marginTop: "10rem" }}>
      <div className="">
        ...
        />
        <div className="landlord__offering">
          <h4>What We Offer?</h4>
          <h2>Work Less, Gain more!</h2>
          <h2>Decrease your Void periods and</h2>
          <h2>Increase Accessibility for renters while minimizing your risk</h2>
        </div>
          ...
          <div className="col-lg-4 col-md-6 p-5">
            <div className="card position-relative">
              ...
              <div className="position-absolute card-top">
                <img
                  src={
                    "https://d1muf25xaso8hp.cloudfront.net/https%3A%2F%2F0da30771b4db22ceee9d298274e16a7c.cdn.bubble.io%2Ff1712692615705x573674704390116200%2Fpexels-photo-18904413.jpeg?w=192&h=257&auto=compress&dpr=1.25&fit=max"
                  }
