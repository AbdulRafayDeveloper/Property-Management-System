            ...
            <div className="d-flex align-items-center">
              <div className="flex-shrink-0">
                ...
                {company.row.original.image_src ? <img
                  ...
                  src={import.meta.env.VITE_API_URL + "/images/" + company.row.original.image_src}
                  alt=""
                ...
                <CardBody className="text-center">
                  <div className="position-relative d-inline-block">
                    <div className="avatar-md">
                      <div className="avatar-title bg-light rounded-circle">
                        <img src={import.meta.env.VITE_API_URL + "/images/" + (info.image_src || "brands/mail_chimp.png")} alt="" className="avatar-sm rounded-circle object-fit-cover" />
                      </div>
                    </div>
                  </div>
