            ...
            <Col xxl={4} lg={6}>
                <Card className="card-height-100">
                    <CardHeader className="align-items-center d-flex">
                        <h4 className="card-title mb-0 flex-grow-1">Money Recieved</h4>
                    ...
                    <CardBody>
                        ...
                        <div className="mt-3">
                            <div className="d-flex justify-content-center align-items-center mb-4">
                                <h2 className="me-3 ff-secondary mb-0">€{chartData[0] + chartData[1] + chartData[2] || 784}</h2>
                                <div>
                                    <p className="text-muted mb-0">Money Recieved</p>
                            ...
                            <div className="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                                <p className="fw-medium mb-0"><i className="ri-checkbox-blank-circle-fill text-success align-middle me-2"></i> Rent</p>
                                <div>
                                    <span className="fw-bold pe-5">€{chartData[0]}</span>
                                    <span className="text-success fw-medium fs-12">36.7%</span>
                                </div>
                            </div>
                            <div className="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                                <p className="fw-medium mb-0"><i className="ri-checkbox-blank-circle-fill text-primary align-middle me-2"></i> Deposit</p>
                                <div>
                                    <span className="fw-bold pe-5">€{chartData[1]}</span>
                                    <span className="text-success fw-medium fs-12">36.7%</span>
                                </div>
                            </div>
                            <div className="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                                <p className="fw-medium mb-0"><i className="ri-checkbox-blank-circle-fill text-warning align-middle me-2"></i> Other</p>
                                <div>
                                    <span className="fw-bold pe-5">€{chartData[2]}</span>
                                    <span className="text-success fw-medium fs-12">26.7%</span>
                                </div>
                            </div>
                        </div>
                    </CardBody>
