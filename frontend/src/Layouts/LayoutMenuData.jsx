...
const Navdata = () => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            click: function (e) {
                e.preventDefault();
                setIscurrentState("savedProperties");
            },
        },
        {
            id: "viewings",
        ...
        },
        {
            ...
            user: ['landlord'],
            icon: "mdi mdi-form-select",
            link: "/submitted-applications",
            click: function (e) {
                e.preventDefault();
                setIscurrentState("submittedApplications");
            },
        },
        {
            id: "tenancies",
