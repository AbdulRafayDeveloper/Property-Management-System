		...
		<React.Fragment>
			<Dropdown isOpen={isProfileDropdown} toggle={toggleProfileDropdown} className="ms-sm-3 header-item topbar-user">
				...
				<DropdownMenu className="dropdown-menu-end">
					...
					<DropdownItem href={import.meta.env.PUBLIC_URL + '/profile'}>
						<i className="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
						<span className="align-middle">Profile</span>
					</DropdownItem>
					<DropdownItem href={import.meta.env.PUBLIC_URL + '/apps-chat'}>
						<i className="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i> <span className="align-middle">Messages</span>
					</DropdownItem>
					<DropdownItem href={import.meta.env.PUBLIC_URL + '#'}>
					...
					<DropdownItem href={import.meta.env.PUBLIC_URL + '/pages-faqs'}>
						<i className="mdi mdi-lifebuoy text-muted fs-16 align-middle me-1"></i> <span className="align-middle">Help</span>
					</DropdownItem>
					<div className="dropdown-divider"></div>
					<DropdownItem href={import.meta.env.PUBLIC_URL + '/pages-profile'}>
						<i className="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i>{' '}
						<span className="align-middle">
							Balance : <b>$5971.67</b>
						</span>
					</DropdownItem>
					<DropdownItem href={import.meta.env.PUBLIC_URL + '/pages-profile-settings'}>
					...
					<DropdownItem href={import.meta.env.PUBLIC_URL + '/auth-lockscreen-basic'}>
