...
import WizardRegister from '../pages/Register/WizardRegister';
...
const authProtectedRoutes = [
  ...
  { path: '/maintenances', component: <JobList /> },
  ...
  // custom pages 
  { path: '/properties', component: <Creators /> },
  { path: '/saved-properties', component: <SavedProperties /> },
  { path: '/application', component: <Application /> },
  { path: '/submitted-applications', component: <LandlordApplication /> },
  { path: '/viewings', component: <Viewings /> },
  { path: '/maintenance', component: <CandidateList /> },
...
const protectedWithoutSidebar = [
  // custom routes 

  { path: '/register/listing', component: <CreateListing /> },
  // end ______________
...
// Casper landing pages URL
const caperLandingRoutes = [
  { path: '/', component: <Home /> },
  { path: '/renters', component: <Renters /> },
  { path: '/landlords', component: <LandLord /> },
  { path: '/listings', component: <Listing /> }
];

export { authProtectedRoutes, publicRoutes, caperLandingRoutes, protectedWithoutSidebar };
